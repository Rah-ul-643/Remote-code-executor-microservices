...
const CodeIDE = () => {
  ...
  useEffect(() => {
    ...
    setSocket(newSocket);
     ...
     newSocket.emit("register-user", decodeUsername(), (submissionHistory) => {
  ...
  useEffect(() => {
    ...
    socket.on("set-submission-history", (submissionHistory) => {
      console.log("Submission History for current user: ", submissionHistory);
    });
